...
private func Initialize()
{
	...
	SetMeshMaterial("ColorMushroom");
	//SetClrModulation(HSL(RandomX(0, 55),255,220));
	if(!Random(4)) SetColor(HSL(0,255,170));
	else SetColor(HSL(RandomX(10, 255),255,170));
}
...
{
	return GetProperty("Collectible") != 1 && _inherited(clonk);
}
